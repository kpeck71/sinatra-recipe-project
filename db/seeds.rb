mario = Cook.create(name:"Mario Mario",username: "mario123", password:"iluvpeach")
luigi = Cook.create(name:"Luigi Mario", username: "luigi456", password: "yoshi")
...
bob = Cook.create(name:"Bob",username:"bobsburgers",password:"lynne")
